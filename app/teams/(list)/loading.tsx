...
/**
 * Dans le groupe `(list)` — qui ne change pas l'URL — pour que la frontière
 * de chargement ne couvre pas `/teams/[teamId]`, qui appelle `notFound()` :
 * le streaming renverrait sinon 200 au lieu de 404.
 * Voir components/skeletons/README.md.
 */
export default function Loading() {
  return (
    <SkeletonScreen label="Chargement des écuries">
